...
#ifndef _MYMSG_PUBSUBTYPES_H_
#define _MYMSG_PUBSUBTYPES_H_
...
#error Generated MyMsg is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type MyMsg defined by the user in the IDL file.
 * @ingroup MYMSG
 */
class MyMsgPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef MyMsg type;

    eProsima_user_DllExport MyMsgPubSubType();

    eProsima_user_DllExport virtual ~MyMsgPubSubType();
